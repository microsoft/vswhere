...
public:
    ...
    TEST_METHOD(Include_Packages)
    {
        ...
        auto expected =
            ...
            L"    <instanceId>a1b2c3</instanceId>\n"
            L"    <installationName>test</installationName>\n"
            L"    <productId>Microsoft.VisualStudio.Product.Community</productId>\n"
            L"    <packages>\n"
            L"      <package>\n"
            L"        <id>A</id>\n"
            L"        <version>1.0</version>\n"
            L"        <type>Workload</type>\n"
            L"      </package>\n"
            L"      <package>\n"
            L"        <id>B</id>\n"
            L"        <version>1.0</version>\n"
            L"        <type>Component</type>\n"
            L"      </package>\n"
            L"    </packages>\n"
            L"  </instance>\n"
            L"  <instance>\n"
            L"    <instanceId>b1c2d3</instanceId>\n"
            L"    <installationName>test</installationName>\n"
            L"    <productId>Microsoft.VisualStudio.Product.Enterprise</productId>\n"
            L"    <packages>\n"
            L"      <package>\n"
            L"        <id>A</id>\n"
            L"        <version>1.0</version>\n"
